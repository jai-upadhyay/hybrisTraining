...
import de.hybris.training.core.jalo.GiftWrapVariant;
...
public abstract class GeneratedTrainingCoreManager extends Extension
{
	...
	public GiftWrapVariant createGiftWrapVariant(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.GIFTWRAPVARIANT );
			return (GiftWrapVariant)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating GiftWrapVariant : "+e.getMessage(), 0 );
		}
	}
	
	public GiftWrapVariant createGiftWrapVariant(final Map attributeValues)
	{
		return createGiftWrapVariant( getSession().getSessionContext(), attributeValues );
	}
	 ...
	 * @return the giftWrap - Gift wrapping is available
	 */
	public String getGiftWrap(final SessionContext ctx, final Product item)
	{
		return (String)item.getProperty( ctx, TrainingCoreConstants.Attributes.Product.GIFTWRAP);
	}
	 ...
	 * @return the giftWrap - Gift wrapping is available
	 */
	public String getGiftWrap(final Product item)
	{
	 ...
	 * @param value the giftWrap - Gift wrapping is available
	 */
	public void setGiftWrap(final SessionContext ctx, final Product item, final String value)
	{
		item.setProperty(ctx, TrainingCoreConstants.Attributes.Product.GIFTWRAP,value);
	}
	 ...
	 * @param value the giftWrap - Gift wrapping is available
	 */
	public void setGiftWrap(final Product item, final String value)
	{
